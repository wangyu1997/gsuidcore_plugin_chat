...
meta_config.chat.Normal.data_url = (
    "https://raw.githubusercontent.com/wangyu1997/file_upload/main/miao.json"
)
...
meta_config.other.setereo.data_url = (
    "https://raw.githubusercontent.com/wangyu1997/file_upload/main/stereo.data"
)
...
def get_config():
    ...
    with open(config_path, "w") as f:
        ...
        with redirect_stdout(f):
            print(config.dump(allow_unicode=True))
